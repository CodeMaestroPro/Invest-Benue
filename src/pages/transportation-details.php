        ...
        <article class="w-full md:w-3/4">
            <section class="bg-gray-200/50">
                ...
                <div class="container md:items-center sm:items-center items-center py-4 px-8 brightness-100">
                    <img src="../../public/assets/images/transport.jpeg" alt="sector-img"
                    ...
                    <p class="text-justify font-normal tracking-tight mt-4">
                        ...
                        growth. Investments in road construction, public transportation,
                        rail system, cargo airports, water transportation system, logistics
                        companies and car assembly plants and dealershipscan have huge
                        returns.
                    </p>
                </div>
            </section>
