...
<footer class="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="">
                ...
                <p class="justify-center">
                    The Benue State Governor His Exellency Rev. Fr.Dr. Hyacinth Alia to attract, facilitate and promote
                    Benue as a top destination of choice for international investors worldwide.
                </p>
            </div>
            <!-- Products section -->
            <div class="">
    ...
    <div class="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
        ...
        <a class="font-semibold text-neutral-600 dark:text-neutral-400" href="#">InvestBenue</a>
    </div>
</footer>
