        ...
        <article class="w-full md:w-3/4 ">
            <section class="bg-gray-200/50">
                ...
                <div class="container md:items-center sm:items-center items-center py-4 px-8 brightness-100">
                    <img src="../../public/assets/images/energy.jpg" alt="sector-img" class="w-full h-96 rounded-md" />
                    <p class="text-justify font-normal tracking-tight mt-4">
                        Benue State has effective sunlight intensity suitable for renewable
                        energy projects. Therefore, to reduce green house emission from
                        existing energy sources and improve the energy demand, huge
                        investments in solar energy and other clean energy- related sources
                        are needed to boost power production in the state.
                    </p>
                </div>
            </section>
        </article>
